 ...
 * @author Flavio
 */
public class cadastro_estacionamento extends javax.swing.JFrame {

    /**
     * Creates new form cadastro_estacionamento
     */
    public cadastro_estacionamento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Preencha os dados para efetuar seu cadastro:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cadastro_estacionamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cadastro_estacionamento().setVisible(true);
            }
        });
    }
