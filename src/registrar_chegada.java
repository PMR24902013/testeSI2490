 ...
 * @author Flavio
 */
public class registrar_chegada extends javax.swing.JFrame {

    /**
     * Creates new form registrar_chegada
     */
    public registrar_chegada() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Preencha os dados da chegada:");
        ...
        jLabel2.setText("Vaga de chegada");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registrar_chegada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registrar_chegada().setVisible(true);
            }
        });
    }
